...
| Debian 12 | ✅ Протестировано |

Другие дистрибутивы на базе Debian в теории могут работать, но не проверялись. Если прогонишь на чём-то ещё и всё сработает — открой [issue](../../issues), добавлю в список.

## Требования

- Ubuntu 22.04 / 24.04 (рекомендуется чистая установка)
- Root или sudo
